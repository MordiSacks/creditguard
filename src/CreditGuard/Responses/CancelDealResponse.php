...
class CancelDealResponse extends AbstractResponse
{

    /** @var \SimpleXMLElement */
    protected $cancelDeal;

    protected function init()
    {
        $this->cancelDeal = $this->xml->response->cancelDeal;
    }

    public function getStatus()
    {
        $field = static::_getterToField(__FUNCTION__);
        return (string)$this->cancelDeal->{$field} ?: null;
    }
