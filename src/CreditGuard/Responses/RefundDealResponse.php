...
class RefundDealResponse extends AbstractResponse
{

    /** @var \SimpleXMLElement */
    protected $refundDeal;

    protected function init()
    {
        $this->refundDeal = $this->xml->response->refundDeal;
    }

    public function getStatus()
    {
        $field = static::_getterToField(__FUNCTION__);
        return (string)$this->refundDeal->{$field} ?: null;
    }
